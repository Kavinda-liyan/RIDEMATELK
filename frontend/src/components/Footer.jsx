  ...
  return (
    <footer className="bg-rmlk-dark-light shadow-xl z-10 py-[24px]">
      <div className="pl-[60px] pr-[60px]">
        <div className="grid grid-cols-4 py-[24px]">
          ...
          <div className="col-span-1">
            ...
            <div className="py-[4px] font-sans text-[12px] text-white"> &copy;{year} All rights reserverd</div>
            <div className="py-[4px] font-sans text-[12px] text-white">Developed by @Kavinda_Liyanaarachchi</div>
          </div>
        </div>
      </div>
    </footer>
